...
const ChatBot: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[60]">
      ...
      {isOpen && (
        <div className="absolute bottom-20 right-0 w-[90vw] md:w-96 bg-white rounded-3xl shadow-2xl border border-slate-100 overflow-hidden flex flex-col h-[500px] animate-in slide-in-from-bottom-4 duration-300">
